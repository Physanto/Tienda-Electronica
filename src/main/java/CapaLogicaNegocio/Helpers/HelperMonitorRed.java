...
/**
 * Clase que se comporta como un daemon para la monitorizacion de la red del
 * sistema.
 *
...
public class HelperMonitorRed extends Thread {
    ...
    // variables de tipo volatile porque se estan manejando hilos asi que se quiere
    // que el cambio sea visible para todos
    ...
    /**
     * Metodo sobreescrito de la clase Thread donde monitorea todo el tiempo el
     * estado de la red
     * haciendo uso del metodo personalizado (HelperRed.verificarConexion)
     * si hay red entonces sincroniza los datos en la nube, de lo contrario cambia
     * el estado de la red
     * este proceso hace el monitoreo cada 5 segundos durante toda la vida del
     * programa
     */
    @Override
    public void run() {
     ...
     * 
     * @return true si hay conexion estable de internet, de lo contrario retorna
     *         false
     */
    public static boolean estaUsandoNube() {
        return usandoNube;
    }

    /**
     * Verifica si la base de datos local esta disponible abriendo una conexion de
     * sondeo que se cierra de inmediato.
     * 
