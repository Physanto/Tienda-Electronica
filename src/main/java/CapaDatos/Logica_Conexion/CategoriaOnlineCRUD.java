...
/**
 * Clase que se encarga de hacer el CRUD en la coleccion Categoria de la base de
 * datos de la nube,
 * esta implementa la interfaz generica definida en el mismo paquete, ademas
 * hace uso de la clase GeneralOnlineProviderCRUD
...
public class CategoriaOnlineCRUD implements IOnlineCRUD<Categoria> {
     ...
     * 
     * @param categoria es el registro de tipo categoria que se quiere agregar a la
     *                  base de datos
    ...
    public boolean registrarNube(Categoria categoria) {
        ...
        if (GeneralOnlineProviderCRUD.existeRegistro("Categoria", categoria.getClass(), id))
            return false;
    ...
    /**
     * Busca en la base de datos de la nube el registro que esta en la "tabla"
     * categoria y si lo encuentra lo retorna
     * 
     * @param categoria es la clase la cual pertenece a los registros, no se espera
     *                  una instancia sino la clase.
     * @return true si inserta el registro correctamente, de lo contrario false;
     */
    @Override
    ...
    /**
     * Busca en la base de datos de la nube todos los registros que estan en la
     * "tabla" categoria y si hay los retorna en una lista
     * 
     * @param categoria es la clase la cual pertenece a los registros, no se espera
     *                  una instancia sino la clase.
    ...
    /**
     * Elimina de la base de datos de la nube el registro identificado con el id
    ...
    /**
     * Actualiza en la base de datos de la nube el registro de tipo categoria que se
     * pasa por argumento
     * 
     * @param categoria es el registro con los datos nuevos que se quieren
     *                  actualizar.
